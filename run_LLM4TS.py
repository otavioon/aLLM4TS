...
parser.add_argument(
    "--pretrain", type=int, default=1, help="whether to use pretrained llm"
)
parser.add_argument(
    "--freeze",
    type=int,
    default=1,
    help="whether to freeze specific part of the llm",
)
parser.add_argument(
    "--llm_layers", type=int, default=1, help="the number of llm layers we use"
)
parser.add_argument(
    "--mask_pt", type=int, default=0, help="mask pratrain ratio"
)
parser.add_argument(
    "--llm", type=str, default="./HF_MODELS/gpt2", help="the llm checkpoint"
)
parser.add_argument("--attn_dropout", type=float, default=0, help="")
parser.add_argument("--proj_dropout", type=float, default=0, help="")
parser.add_argument(
    "--res_attention", action="store_true", default=False, help=""
)
...
parser.add_argument(
    ...
    type=str,
    default="null",
    help="the layers in llm needed to be trained",
)
parser.add_argument(
    "--history_len", type=int, default=0, help="look-back window length"
)
parser.add_argument("--fft", type=int, default=0, help="fft")
parser.add_argument("--rand_init", type=int, default=0, help="rand_init")
# pt
parser.add_argument(
    "--c_pt", type=int, default=0, help="whether continue pretrain"
)
parser.add_argument(
    "--pt_layers",
    type=str,
...
parser.add_argument(
    ...
    type=str,
    default="null",
    help="the dataset used in pretrain, use _ to separate",
)
parser.add_argument(
    "--pt_sft", type=int, default=0, help="whether continue pretrain"
)
parser.add_argument(
    "--pt_sft_base_dir",
    type=str,
    default="null",
    help="the base model dir for pt_sft",
)
parser.add_argument(
    "--pt_sft_model", type=str, default="null", help="the base model for pt_sft"
)
parser.add_argument(
    "--load_last", action="store_true", help="load last checkpoint"
)
...
parser.add_argument(
    "--label_len", type=int, default=0, help="start token length"
)
parser.add_argument(
...
parser.add_argument(
    "--head_dropout", type=float, default=0.0, help="head dropout"
)
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="continue training from a specific checkpoint (name of the checkpoint file without the checkpoint directory)",
)
parser.add_argument(
    "--resume_from_epoch",
    type=int,
...
parser.add_argument(
    "--perform_instance_norm",
    type=str2bool,
    help="perform instance normalization in instances of dataset",
    const=True,
    default=True,
    nargs="?",
)
