...
for patch in 16 ; do
    for stride in 16 ; do
        python run_LLM4TS.py \
            ...
            --model_id LLM4TS_cls_EthanolConcentration \
            --model LLM4TS_cls \
            --data UEA \
            --is_llm 1 \
            --pretrain 1 \
            ...
            --checkpoints ./checkpoints/classification_no_pretrain/EthanolConcentration \
            --des exp \
            --lradj type1 \
            --use_gpu 1 \
            --devices 0 \
            --gpu 0 \
            --num_workers 0 2>&1 | tee logs/classification_no_pretrain/EthanolConcentration_patch-${patch}_stride-${stride}.log 
    done
done